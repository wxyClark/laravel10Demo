            ...
            <div class="flex items-center">
                <div class="ml-3 relative">
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-700 dark:text-gray-300 text-sm">开发者</span>
...
<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- 标题区域 -->
        <div class="mb-8">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">SQL 查询工具</h1>
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">执行安全的SELECT查询并导出结果</p>
        </div>
